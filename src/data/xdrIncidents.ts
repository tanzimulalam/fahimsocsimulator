...
export const xdrIncidents: XDRIncident[] = [
  ...
  },
  {
    ...
    users: ["IIS_IUSRS"],
    sha256: [{ hash: "4f5e6d7c8b9a0f1e2d3c4b5a6d7e8f9c0b1a2d3e4f5c6b7a8d9e0f1c2b3a4d5e", filename: "webshell.aspx", verdict: "malicious" }],
  ...
  },
  {
    ...
    users: ["m.rodriguez"],
    sha256: [{ hash: "ed01ebfbc9eb5bbea545af4d01bf5f1071661840480439c6e5babe8e080e41aa", filename: "@WanaDecryptor", verdict: "malicious" }],
    c2Ips: [],
    c2Domains: [],
    cves: ["CVE-2017-0144"],
    attackGraph: {
  ...
  },
  {
    ...
    users: ["d.patel"],
    sha256: [{ hash: "a3b8f9d4c2e1f7a6b5c3d9e0f4a7b2c8d1e5f9a3b6c0d4e8f2a5b9c3d7e1f6a0", filename: "Emotet.dll", verdict: "malicious" }],
  ...
  },
  {
    ...
    sha256: [{ hash: "1f1aabe87e5e93a8fff769bf3614dd559c51c80fc045e11868f3843d9a004d1e", filename: "mshta payload", verdict: "malicious" }],
    c2Ips: ["151.101.65.91"],
    c2Domains: [],
    cves: [],
    attackGraph: {
  ...
  },
  {
    ...
    sha256: [{ hash: "a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4e5f6a1b2", filename: "wsmprovav.exe", verdict: "malicious" }],
    c2Ips: [],
    c2Domains: [],
    cves: [],
    attackGraph: {
  ...
  },
  {
    ...
    users: ["leeg"],
    sha256: [{ hash: "7d8e9f0a1b2c3d4e5f6a7b8c9d0e1f2a3b4c5d6e7f8a9b0c1d2e3f4a5b6c7d8e", filename: "AsyncRAT variant", verdict: "malicious" }],
    c2Ips: ["94.232.41.155"],
    c2Domains: [],
    cves: [],
    attackGraph: {
  ...
  },
  {
    ...
    sha256: [{ hash: "e8c7b6a5d4c3b2a1f0e9d8c7b6a5d4c3b2a1f0e9d8c7b6a5d4c3b2a1f0e9d8c7", filename: "Cobalt Strike beacon", verdict: "malicious" }],
    c2Ips: ["203.0.113.47"],
  ...
  },
  {
    ...
    users: ["finance.user"],
    sha256: [{ hash: "7b6c5a4d3e2f1c0b9a8d7e6f5c4b3a2d1e0f9c8b7a6d5e4f3c2b1a0d9e8f7c6b", filename: "LockerGoga sample", verdict: "malicious" }],
    c2Ips: [],
    c2Domains: [],
    cves: [],
    attackGraph: {
  ...
  },
  {
    ...
    host: "10.4.21.77",
    users: ["SYSTEM"],
    sha256: [{ hash: "d0d626deb3f9484e649294a8dded4516a6b7b5a08e2be2ce0e5e47a37ed77ccd", filename: "SUNBURST", verdict: "malicious" }],
    c2Ips: [],
  ...
  },
  {
    ...
    sha256: [
      { hash: "8d4b2e1f9c7a3b5d4e8f2c6a1b9d7e3f5c4a2b8d6e9f1c3a7b4d2e8f6c9a1b3", filename: "Log4Shell dropper", verdict: "malicious" },
      { hash: "e8c7b6a5d4c3b2a1f0e9d8c7b6a5d4c3b2a1f0e9d8c7b6a5d4c3b2a1f0e9d8c7", filename: "Cobalt Strike", verdict: "malicious" }
    ],
    c2Ips: ["203.0.113.47"],
    c2Domains: [],
    cves: ["CVE-2021-44228"],
    ...
    detectionEvents: [
      { id: "ev1", firstSeen: "22 hours ago", severity: "Critical", source: "Cisco Secure Endpoint", indicators: ["Log4Shell Exploit Attempt"], observables: ["8d4b2e1f9c7a3b5d4e8f2c6a1b9d7e3f5c4a2b8d6e9f1c3a7b4d2e8f6c9a1b3"], assets: ["web-prod-01"] },
      { id: "ev2", firstSeen: "22 hours ago", severity: "Critical", source: "CrowdStrike Falcon", indicators: ["CobaltStrike Beacon"], observables: ["e8c7b6a5d4c3b2a1f0e9d8c7b6a5d4c3b2a1f0e9d8c7b6a5d4c3b2a1f0e9d8c7"], assets: ["web-prod-01"] },
