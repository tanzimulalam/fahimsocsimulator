  ...
  },
  {
    ...
    attackGraph: {
      nodes: [
        ...
        { id: "n3", type: "ip", label: "anon-cloud-storage.com", disposition: "suspicious" }
      ],
      edges: [
        { source: "n1", target: "n2" },
        { source: "n2", target: "n3" }
  ...
  },
  {
    ...
    attackGraph: {
      nodes: [
        ...
        { id: "n3", type: "ip", label: "supportxmr.com", disposition: "malicious" }
      ],
      edges: [
        { source: "n1", target: "n2" },
        { source: "n2", target: "n3" }
  ...
  },
  {
    ...
    attackGraph: {
      nodes: [
        ...
        { id: "n3", type: "ip", label: "198.51.100.50", disposition: "malicious" }
      ],
      edges: [
        { source: "n1", target: "n2" },
        { source: "n2", target: "n3" }
  ...
  },
  {
    ...
    attackGraph: {
      nodes: [
        ...
        { id: "n3", type: "ip", label: "c2.malicious.net", disposition: "malicious" }
      ],
      edges: [
        { source: "n1", target: "n2" },
        { source: "n2", target: "n3" }
  ...
  },
  {
    ...
    attackGraph: {
      nodes: [
        ...
        { id: "n3", type: "ip", label: "anydesk.com", disposition: "suspicious" }
      ],
      edges: [
        { source: "n1", target: "n2" },
        { source: "n2", target: "n3" }
