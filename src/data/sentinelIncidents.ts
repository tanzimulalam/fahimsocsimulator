...
export const SENTINEL_INCIDENTS: SentinelIncident[] = [
  ...
  },
  {
    id: "SENT-3017",
    displayId: 30017,
    title: "RDP brute force: 847 failed logins → successful access — LAB-WS-0142",
    severity: "High",
    status: "New",
    owner: null,
    ...
    alertCount: 2,
    entities: [
      { type: "host", value: "LAB-WS-0142" },
      { type: "account", value: "MdUsman" },
      { type: "ip", value: "185.220.101.47" },
      { type: "account", value: "svc_backup01" },
    ],
    productNames: ["Microsoft Sentinel"],
    analyticRuleId: "AR-0001",
    created: T("2026-05-27T02:47:00Z"),
    lastUpdated: T("2026-05-27T02:50:00Z"),
    description: "Analytic rule AR-0001 triggered: 847 Event ID 4625 failures from 185.220.101.47 against MdUsman on LAB-WS-0142 between 02:31–02:47, followed by a successful Event ID 4624 logon. New local account svc_backup01 created immediately post-login — likely attacker persistence.",
    closeClassification: "Not set",
  ...
  },
  {
    id: "SENT-3018",
    displayId: 30018,
    title: "Impossible travel: svc_backup — Clifton Park NY → Bucharest RO in 12 min",
    severity: "High",
    status: "New",
    owner: null,
    tactics: ["InitialAccess", "CredentialAccess"],
    ...
    alertCount: 1,
    entities: [
      { type: "account", value: "svc_backup@datagroup.com" },
      { type: "ip", value: "45.84.68.22" },
      { type: "ip", value: "194.165.16.78" },
    ],
    productNames: ["Microsoft Entra ID Protection"],
    analyticRuleId: "AR-0004",
    created: T("2026-05-28T07:43:00Z"),
    lastUpdated: T("2026-05-28T07:44:00Z"),
    description: "Impossible travel alert: svc_backup authenticated from Clifton Park NY (45.84.68.22) at 07:31, then from Bucharest RO (194.165.16.78) at 07:43 — physically impossible within 12 minutes. Service account compromise suspected.",
    closeClassification: "Not set",
