...
export const INITIAL_SERVICENOW_TICKETS: SnTicket[] = [
  ...
  },
  {
    ...
    shortDescription: "Umbrella App Discovery: Review High Risk App 'Hola VPN'",
    description: "Our weekly automated App Discovery report flagged a high-risk application 'Hola VPN' being used by several employees. Please log in to the Cisco Umbrella App Discovery simulator (https://tinyurl.com/FahimUmbrella), search for 'Hola VPN', review its risk score, and decide if it should be blocked. Document your decision here.",
  ...
  },
  {
    ...
    shortDescription: "Umbrella App Discovery: Review Cloud Storage App 'Mega'",
    description: "We are auditing shadow IT cloud storage. Please log in to the Cisco Umbrella App Discovery simulator (https://tinyurl.com/FahimUmbrella) and review the app 'Mega'. Since we officially use OneDrive, we need to determine if 'Mega' poses an unacceptable data exfiltration risk based on its Umbrella score and classifications. Update the ticket with your findings.",
