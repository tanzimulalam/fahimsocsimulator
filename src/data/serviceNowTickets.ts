...
export const INITIAL_SERVICENOW_TICKETS: SnTicket[] = [
  ...
  {
    number: "INC0162946",
    openedAt: "2026-07-15 14:30:00 PM",
    shortDescription: "Suspicious Rclone Data Exfiltration",
    description: "XDR INC-XDR-021. Review outbound traffic and cloud storage destinations.",
    caller: "System: XDR",
    category: "Security",
    ...
    attachments: [],
    activities: [],
    linkedXdrIncidentId: "INC-XDR-021", email: "user@datagroup.com", phone: "555-1234", location: "Remote", businessServices: "Security", configurationItem: "Workstation"
  },
  {
    number: "INC0162947",
    openedAt: "2026-07-16 09:15:00 AM",
    shortDescription: "macOS XMRig Cryptominer",
    description: "XDR INC-XDR-022. High CPU usage on MKT-MAC-02.",
    caller: "System: XDR",
    category: "Security",
    subcategory: "Malware",
    channel: "API",
    ...
    attachments: [],
    activities: [],
    linkedXdrIncidentId: "INC-XDR-022", email: "user@datagroup.com", phone: "555-1234", location: "Remote", businessServices: "Security", configurationItem: "Workstation"
  },
  {
    number: "INC0162948",
    openedAt: "2026-07-16 11:45:00 AM",
    shortDescription: "Web Shell Activity on DEV-LNX-01",
    description: "XDR INC-XDR-023. Reverse shell connection established from web server.",
    caller: "System: XDR",
    category: "Security",
    ...
    attachments: [],
    activities: [],
    linkedXdrIncidentId: "INC-XDR-023", email: "user@datagroup.com", phone: "555-1234", location: "Remote", businessServices: "Security", configurationItem: "Workstation"
  },
  {
    number: "INC0162949",
    openedAt: "2026-07-17 08:20:00 AM",
    shortDescription: "Mimikatz Credential Dumping Attempt",
    description: "XDR INC-XDR-024. LSASS access blocked on HR-WS-05.",
    caller: "System: XDR",
    category: "Security",
    ...
    attachments: [],
    activities: [],
    linkedXdrIncidentId: "INC-XDR-024", email: "user@datagroup.com", phone: "555-1234", location: "Remote", businessServices: "Security", configurationItem: "Workstation"
  },
  {
    number: "INC0162950",
    openedAt: "2026-07-17 10:05:00 AM",
    shortDescription: "LockBit Ransomware Precursor detected",
    description: "XDR INC-XDR-025. Immediate isolation required for FIN-LAPTOP-02.",
    caller: "System: XDR",
    category: "Security",
    subcategory: "Malware",
    channel: "API",
    ...
    attachments: [],
    activities: [],
    linkedXdrIncidentId: "INC-XDR-025", email: "user@datagroup.com", phone: "555-1234", location: "Remote", businessServices: "Security", configurationItem: "Workstation"
  },
  {
    number: "INC0162951",
    openedAt: "2026-07-17 13:40:00 PM",
    shortDescription: "Malicious npm Package Execution",
    description: "XDR INC-XDR-026. Developer installed typosquatted package.",
    caller: "System: XDR",
    category: "Security",
    subcategory: "Malware",
    channel: "API",
    ...
    attachments: [],
    activities: [],
    linkedXdrIncidentId: "INC-XDR-026", email: "user@datagroup.com", phone: "555-1234", location: "Remote", businessServices: "Security", configurationItem: "Workstation"
  },
  {
    number: "INC0162952",
    openedAt: "2026-07-17 15:10:00 PM",
    shortDescription: "AnyDesk installed via Phishing",
    description: "XDR INC-XDR-027. Unauthorized RMM tool installed on LAB-WS-0188.",
    caller: "System: XDR",
    category: "Security",
    subcategory: "Phishing",
    channel: "API",
    ...
    attachments: [],
    activities: [],
    linkedXdrIncidentId: "INC-XDR-027", email: "user@datagroup.com", phone: "555-1234", location: "Remote", businessServices: "Security", configurationItem: "Workstation"
  }
];
