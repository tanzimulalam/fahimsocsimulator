...
export const INITIAL_INCIDENTS: Incident[] = [
  ...
  },
  {
    id: "inc-21",
    status: "requires_attention",
    hostLine: "SALES-LAPTOP-08.datagroup.local",
    groupName: "Defender ATP Group FacStaff",
    eventCount: 3,
    recordCount: 1,
    host: {
      ...hostFahim,
      hostname: "SALES-LAPTOP-08.datagroup.local",
      os: "Windows 10 Pro",
      group: "Defender ATP Group FacStaff",
      policy: "Defender ATP Policy — FacStaff",
      internalIp: "10.4.15.22",
      externalIp: "198.51.100.22",
      riskScore: 85,
    },
    events: [
    ...
    vulnerabilitiesNote: "Outdated browser observed.",
    xdrSir: XDR_SIR_BY_INCIDENT_ID["inc-21"],
  },
  {
    id: "inc-22",
    status: "requires_attention",
    hostLine: "MKT-MAC-02.corp.local",
    groupName: "IT Support Pool",
    eventCount: 5,
    recordCount: 2,
    host: {
      ...hostFahim,
      hostname: "MKT-MAC-02.corp.local",
      os: "macOS 13.4",
      group: "IT Support Pool",
      policy: "Lab — Standard",
      internalIp: "10.8.2.14",
    ...
    vulnerabilitiesNote: "No known vulnerabilities.",
    xdrSir: XDR_SIR_BY_INCIDENT_ID["inc-22"],
  },
  {
    id: "inc-23",
    status: "requires_attention",
    ...
    host: {
      ...hostFahim,
      hostname: "DEV-LNX-01.datagroup.local",
      os: "Ubuntu 22.04 LTS",
      group: "Data Group — SOC Lab",
      policy: "Server Policy",
      internalIp: "10.10.5.50",
    ...
    vulnerabilitiesNote: "SSH exposed to internal network.",
    xdrSir: XDR_SIR_BY_INCIDENT_ID["inc-23"],
  },
  {
    id: "inc-24",
    status: "requires_attention",
    hostLine: "HR-WS-05.datagroup.local",
    groupName: "Defender ATP Group FacStaff",
    eventCount: 4,
    recordCount: 1,
    host: {
      ...hostFahim,
      hostname: "HR-WS-05.datagroup.local",
      os: "Windows 11",
      group: "Defender ATP Group FacStaff",
      policy: "Defender ATP Policy — FacStaff",
      internalIp: "10.4.15.55",
      externalIp: "198.51.100.55",
      riskScore: 65,
    },
    events: [
    ...
    vulnerabilitiesNote: "Adobe Reader out of date.",
    xdrSir: XDR_SIR_BY_INCIDENT_ID["inc-24"],
  },
  {
    id: "inc-25",
    status: "requires_attention",
    ...
    host: {
      ...hostFahim,
      hostname: "FIN-LAPTOP-02.corp.local",
      os: "Windows 10 Pro",
      group: "Defender ATP Group FacStaff",
      policy: "Defender ATP Policy — FacStaff",
      internalIp: "10.4.16.10",
    ...
    vulnerabilitiesNote: "Multiple unpatched CVEs.",
    xdrSir: XDR_SIR_BY_INCIDENT_ID["inc-25"],
  },
  {
    id: "inc-26",
    status: "requires_attention",
    hostLine: "EXEC-MAC-01.datagroup.local",
    groupName: "IT Support Pool",
    eventCount: 1,
    recordCount: 1,
    host: {
      ...hostFahim,
      hostname: "EXEC-MAC-01.datagroup.local",
      os: "macOS 14.1",
      group: "IT Support Pool",
      policy: "Lab — Standard",
      internalIp: "10.8.2.5",
    ...
    vulnerabilitiesNote: "None.",
    xdrSir: XDR_SIR_BY_INCIDENT_ID["inc-26"],
  },
  {
    id: "inc-27",
    status: "requires_attention",
    hostLine: "LAB-WS-0188.campus.local",
    groupName: "Defender ATP Group LabClass",
    eventCount: 2,
    recordCount: 1,
    host: {
      ...hostFahim,
      hostname: "LAB-WS-0188.campus.local",
      os: "Windows 11 Education",
      group: "Defender ATP Group LabClass",
      policy: "Lab Class — Windows",
      internalIp: "10.8.1.88",
      externalIp: "203.0.113.88",
      riskScore: 80,
    },
    events: [
    ...
    vulnerabilitiesNote: "Suspicious scheduled task.",
    xdrSir: XDR_SIR_BY_INCIDENT_ID["inc-27"],
  }
];
